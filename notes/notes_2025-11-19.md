...
5. Journal configuration does not appear to be used (`decor`).

6. What is a good "Pyre" way to organize components based on physics? How should I name protocols and families?
...
8. `mm` does not appear to be building the Pyre mpi package. I have MPI installed in `/software/baagaard/openmpi-5.0/gcc-11.4/`.
