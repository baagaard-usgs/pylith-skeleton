...
1. What is the best way to provide defaults for a component based on its family name? What is required for this to work? Does `import pylith` need to provide `pylith.governing_eqns.elasticity` or can it be imported using`import pylith.governing_eqns.elasticity`?
