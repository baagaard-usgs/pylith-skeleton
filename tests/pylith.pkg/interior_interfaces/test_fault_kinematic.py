...
def load_yaml():
    ...
    pylith.loadConfiguration(cur_path / "test_fault_kinematic.yaml")
...
def test_traits_yaml(load_yaml, local_test_subject):
    ...
    assert fault.edge_label_value == 4
    assert fault.ref_dir_1 == [1.0, 0.0, 0.0]
    assert fault.ref_dir_2 == [0.0, 0.0, 1.0]
