...
Command line options are tied to comonents and their state. Can set via command line, YAML, etc. Undocumented options (not doc or tip). Not showing -config is a bug. TODO: Open issue in GitHub. Michael wants to go through list. --help is special. Intended to have help component but never materialized.
