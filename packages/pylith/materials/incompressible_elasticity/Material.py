...
class IncompressibleElasticity(
    MaterialBase, family="pylith.materials.incompressible_elasticity"
):
    ...
    def setState(self, t):
        """Set material state."""
        print(
            f"Setting state for incompressible elasticity material '{self.pyre_name}'..."
        )
    ...
    def computeState(self, t):
        ...
        print(
            f"Computing state for incompressible elasticity material '{self.pyre_name}'..."
        )
